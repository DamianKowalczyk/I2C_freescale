...
#define CPU_DERIVATIVE_MCF51AC256A     /* Name of the selected cpu derivative */
#define CPU_PARTNUM_MCF51AC256ACLK     /* Part number of the selected cpu */
